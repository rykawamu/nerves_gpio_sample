defmodule Blink7segLed do
  @moduledoc """
  Documentation for Blink7segLed.
  """
  ...
  def start(_type, _args) do
    ...
    ## 7seg led
    gpio_no_list = Application.get_env(:blink_7seg_led, :gpio_no_list)
    spawn(fn -> blink_7led_forever(gpio_no_list, 0) end)

    ## 4digit 7seg led
    #gpio_no_list = Application.get_env(:blink_7seg_led, :gpio_no_list)
    digit_gpio_no_list = Application.get_env(:blink_7seg_led, :digit_gpio_no_list)
    spawn(fn -> blink_4digit_7led_forever([], digit_gpio_no_list, 0) end)
  ...
  defp blink_4digit_7led_forever([], digit_gpio_no_list, count) do
    blink_4digit_7led(digit_gpio_no_list, count)
    next_count = rem(count + 1, 4)
    blink_4digit_7led_forever([], digit_gpio_no_list, next_count)
  end

  defp blink_4digit_7led(digit_gpio_no_list, count) do
